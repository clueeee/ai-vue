    ...
    <div class="sidebar">
      ...
      <div class="ai-assistant-info">
        <div class="breathing-circle">
          <img :src="iconUrl" style="width: 25px; height: 25px" alt="AI助手" />
        </div>
      ...
      <div class="chat-header">
        <div class="header-left">
          <div class="chat-avatar">
            <img :src="iconUrl1" style="width: 30px; height: 30px" />
          </div>
          <div class="chat-info">
            <h2>宁渡AI助手</h2>
            <p>您的贴心AI心理健康助手</p>
        ...
        <div class="message-item ai-message" v-if="messages.length === 0">
          ...
          <div class="message-content">
            <div class="message-bubble">
              <p>
                您好！我是小暖，您的AI心理健康助手。很高兴陪伴你，为您提供温暖的心理支持。请告诉我，今天您感觉怎么样？有什么想要分享的吗？
              </p>
            </div>
...
const sendMessage = () => {
  ...
  if (isAiTyping.value) {
    ElMessage.error("AI助手正在输入中，请请稍后再试");
    return;
  }
